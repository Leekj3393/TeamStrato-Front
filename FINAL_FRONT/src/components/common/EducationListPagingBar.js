import PagingBarCSS from './EducationListPagingBar.module.css';

function EducationListPagingBar({ pageInfo, setCurrentPage }) {
...
export default EducationListPagingBar;